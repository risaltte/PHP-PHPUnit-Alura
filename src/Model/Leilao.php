...
class Leilao
{
    ...
    public function recebeLance(Lance $lance)
    {
        if (!empty($this->lances) && $this->ehDoUltimoUsuario($lance)) {
            throw new \DomainException('Usuário não pode propor 2 lances consecultivos');
        }

        $totalLancesUsuario = $this
            ->quantidadeDeLancesPorUsuaio($lance->getUsuario());
    ...
    private function quantidadeDeLancesPorUsuaio(Usuario $usuario): int
    {
